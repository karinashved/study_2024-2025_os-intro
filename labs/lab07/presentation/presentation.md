...
## Задание 1. Выполним примеры, приведённые в первой части описания лабораторной работы

![1.1](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-01-50.jpg){#fig:001 width=70%}

# Задание 2. Далее я начинаю выполнять следующие действия (копировать, перемещать, переименовывать)

![ выполнение 2 пункта](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-54.jpg){#fig:002 width=70%}

# Задание 3. Далее я определяю опции команды chmod.
...
![ выполнение команды chmod](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-08-16.jpg){#fig:003 width=70%}

# Я начинаю выполнять задание 4

![ содержимое файла passwd. Для этого я ввожу less /etc/passwd](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-10-07.jpg){#fig:004 width=70%}

![ выполнение 4 пункта](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-11-33.jpg){#fig:005 width=70%}

# Продолжение 4 задания

![ выполнение 4 пункта](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-12-16.jpg){#fig:006 width=70%}
...
Формат команды: cat имя-файла.Для просмотра больших файлов используйте команду less — она позволяет осуществлять постраничный просмотр файлов (длина страницы соответствует размеру экрана).Формат команды: less имя-файла
...
# Назовите и дайте характеристику командам перемещения и переименования файлов и каталогов.
Ответ:
