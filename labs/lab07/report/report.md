...
![1.1](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-01-50.jpg){#fig:001 width=70%}

![1.2](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-04.jpg){#fig:002 width=70%}

![1.3](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-11.jpg){#fig:003 width=70%}

![1.4](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-27.jpg){#fig:004 width=70%}

![1.5](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-32.jpg){#fig:005 width=70%}

![1.6](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-40.jpg){#fig:006 width=70%}

![1.7](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-44.jpg){#fig:007 width=70%}

**Задание 2**
Далее я начинаю выполнять следующие действия:
...
![ выполнение 2 пункта](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-02-54.jpg){#fig:008 width=70%}

**Задание 3**
Далее я определяю опции команды chmod.
...
x — право на выполнение (для каталогов это право на вход).

- — отсутствие права.

Присваиваю указанным в лабораторной работе файлам  права доступа

![ выполнение команды chmod](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-08-16.jpg){#fig:009 width=70%}

**Задание 4**

Я начинаю выполнять следующие действия : 
...
![ содержимое файла passwd. Для этого я ввожу less /etc/passwd](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-10-07.jpg){#fig:010 width=70%}

Копирую файл ~/feathers в файл ~/file.old.Перемещаю файл ~/file.old в каталог ~/play.
Копирую каталог ~/play в каталог ~/fun.Перемещаю каталог ~/fun в каталог ~/play и зову его games

![ выполнение 4 пункта](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-11-33.jpg){#fig:011 width=70%}

Лишаю владельца файла ~/feathers права на чтение. Когда я пытаюсь просмотреть файл командой  сat то, как и предполагалось, мне отказали в доступе, так как я только что убрала у владельца файла (меня) право читать (просматривать) этот файл.  Перемещать также не получилось, так как у меня нет на это права

![ выполнение 4 пункта](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-12-16.jpg){#fig:012 width=70%}

Даю владельцу файла ~/feathers право на чтение.Лишаю владельца каталога ~/play права на выполнение. Поскольку мы только что лишили владельца каталога ~/play права на выполнение, то при попытке перейти в этот каталог с помощью cd возникнет ошибка. Это произойдет, потому что для входа в каталог нужно иметь право на выполнение.Далее даю владельцу каталога ~/play право на выполнение

![ выполнение 4 пункта](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-13-04.jpg){#fig:013 width=70%}

![Читаю  man по командам mount, fsck, mkfs, kill ](/home/vboxuser/Desktop/labsreports/lab7/report/image/photo_2025-03-27_18-14-06.jpg){#fig:014 width=70%}

**Команды mount, fsck, mkfs, kill и их использование в Linux**:

mount — команда для монтирования файловых систем. Она позволяет подключить файловую систему (например, с раздела жесткого диска) к существующей структуре каталогов системы. Пример: mount /dev/sdb1 /mnt. В этом примере файловая система с устройства /dev/sdb1 монтируется в каталог /mnt.

fsck (file system check) — команда для проверки целостности файловой системы. Она анализирует и, если нужно, исправляет ошибки в файловой системе. Пример: fsck /dev/sdb1. Этот пример проверяет файловую систему на устройстве /dev/sdb1 и исправляет ошибки, если они обнаружены.

mkfs (make filesystem) — команда для создания файловой системы на дисковом разделе или другом устройстве. Например, для создания файловой системы ext4 на устройстве /dev/sdb1: mkfs.ext4 /dev/sdb1. Этот пример форматирует устройство /dev/sdb1 и создает файловую систему ext4.

kill — команда для отправки сигналов процессам, обычно используется для завершения процессов. Пример: kill 1234. Этот пример отправляет сигнал процессу с PID (идентификатор процесса) 1234, чтобы завершить его выполнение.
